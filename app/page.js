          ...
          return (
            <div key={i} className="row">
              ...
              <div style={{ textAlign: 'right' }}>
                ...
                <span className={`pill ${pillClass}`}>{kmText}</span>
              </div>
            </div>
          );
        })}
...
// ── Price Recommender Data ────────────────────────────────────────────────────
const vehicleData = {
  sprinter319: {
    label: 'Sprinter 319CDI', avgFees: 876, avgKm: 266641, avgYear: 2017, kmRate: 30, yearRate: 200,
    purchases: [
      { date: 'Oct 2024', invoice: 'BI000363591', price: 15000, km: 286822, year: 2018 },
      { date: 'Nov 2024', invoice: 'BI000378493', price: 15000, km: 287165, year: 2018 },
      { date: 'Jan 2025', invoice: 'BI000398390', price: 17000, km: 256052, year: 2017 },
      { date: 'Jun 2025', invoice: '5303125455 (Manheim)', price: 18500, km: 236546, year: 2017 },
    ],
    note: '319CDI = 3.0L 6-cyl diesel. Prices trending up into 2025. Km adj ±$30/10k km; year adj ±$200/yr.',
  },
  sprinter313316: {
    label: 'Sprinter 313/316CDI', avgFees: 863, avgKm: 258000, avgYear: 2017, kmRate: 25, yearRate: 150,
    purchases: [
      { date: 'Nov 2024', invoice: 'BI000373941', price: 15500, km: 296019, year: 2018 },
      { date: 'Jan 2025', invoice: 'BI000406698', price: 13250, km: 212891, year: 2017 },
      { date: 'Apr 2025', invoice: 'BI000449198', price: 16000, km: 238129, year: 2018 },
      { date: 'Apr 2025', invoice: 'BI000450447', price: 11100, km: 275423, year: 2017 },
      { date: 'Apr 2025', invoice: 'BI000451946', price: 18200, km: 208282, year: 2018 },
      { date: 'Jun 2025', invoice: 'BI000485429', price: 18000, km: 203992, year: 2017 },
      { date: 'Jun 2025', invoice: 'BI000489406', price: 18900, km: 277388, year: 2019 },
      { date: 'Sep 2025', invoice: 'BI000537207', price: 12500, km: 202515, year: 2017 },
      { date: 'Sep 2025', invoice: 'BI000544608', price: 7250, km: 256584, year: 2017 },
      { date: 'Oct 2025', invoice: 'BI000558882', price: 9700, km: 377045, year: 2017 },
      { date: 'Dec 2025', invoice: 'BI000592991', price: 13300, km: 262555, year: 2018 },
      { date: 'Jan 2026', invoice: 'BI000614540', price: 15000, km: 369098, year: 2016 },
    ],
    note: '2.1L 4-cyl. Clean work-ready vans sit at $13k-$18k. Km adj ±$25/10k km; year adj ±$150/yr.',
  },
  hiaceLWB: {
    label: 'Hiace LWB (KDH201R)', avgFees: 873, avgKm: 262000, avgYear: 2016, kmRate: 25, yearRate: 200,
    purchases: [
      { date: 'Nov 2024', invoice: 'BI000374951', price: 10800, km: 266944, year: 2007 },
      { date: 'Nov 2024', invoice: 'BI000386836', price: 13000, km: 264870, year: 2017 },
      { date: 'Jan 2025', invoice: '5303009088 (Manheim)', price: 15000, km: 234642, year: 2014 },
      { date: 'Jan 2025', invoice: 'BI000405225', price: 16900, km: 196969, year: 2016 },
      { date: 'Feb 2025', invoice: 'BI000415363', price: 13100, km: 306127, year: 2015 },
      { date: 'Jul 2025', invoice: 'BI000495834', price: 17000, km: 258693, year: 2015 },
      { date: 'Aug 2025', invoice: 'BI000523376', price: 16750, km: 219505, year: 2016 },
      { date: 'Feb 2026', invoice: 'BI000630252', price: 14500, km: 298490, year: 2015 },
      { date: 'Mar 2026', invoice: 'BI000634176', price: 14000, km: 315958, year: 2016 },
      { date: 'Feb 2026', invoice: 'BI000621012', price: 17750, km: 260539, year: 2016 },
      { date: 'Apr 2026', invoice: 'BI000650289 Lot38', price: 14900, km: 303602, year: 2016 },
      { date: 'Apr 2026', invoice: 'BI000650289 Lot39', price: 14900, km: 266538, year: 2014 },
      { date: 'May 2026', invoice: 'BI000667357', price: 13500, km: 208618, year: 2014 },
      { date: 'May 2026', invoice: 'BI000672840', price: 15000, km: 271338, year: 2016 },
    ],
    note: 'KDH201R standard LWB. 14 purchases. Current market $13,500-$17,750. Km adj ±$25/10k km; year adj ±$200/yr.',
  },
  hiaceSLWB: {
    label: 'Hiace SLWB (KDH221R)', avgFees: 960, avgKm: 278022, avgYear: 2016, kmRate: 25, yearRate: 200,
    purchases: [
      { date: 'Nov 2024', invoice: 'BI000378493', price: 17100, km: 259482, year: 2014 },
      { date: 'Dec 2024', invoice: 'BI000386159', price: 18600, km: 232919, year: 2017 },
      { date: 'Mar 2026', invoice: 'BI000637933', price: 19200, km: 199722, year: 2014 },
      { date: 'Mar 2026', invoice: 'BI000643679', price: 15000, km: 312063, year: 2014 },
      { date: 'Mar 2026', invoice: 'BI000631279', price: 16700, km: 330306, year: 2019 },
      { date: 'May 2026', invoice: 'BI000674626', price: 14200, km: 333945, year: 2016 },
    ],
    note: 'KDH221R high-roof 5-door. Low-km examples under 200k reaching $19k+. Km adj ±$25/10k km; year adj ±$200/yr.',
  },
};

function weightedAvg(purchases) {
  let totalW = 0, sum = 0;
  purchases.forEach((p, i) => { const w = i + 1; sum += p.price * w; totalW += w; });
  return sum / totalW;
}

// ── Price Recommender Component ───────────────────────────────────────────────
function PriceRecommender() {
  ...
  const calculate = () => {
    ...
    const v = vehicleData[vehicleKey];
    const base = weightedAvg(v.purchases);
    const kmAdj = km ? ((v.avgKm - parseInt(km)) / 10000) * v.kmRate : 0;
    const yearAdj = year ? (parseInt(year) - v.avgYear) * v.yearRate : 0;
    const condMult = condition === 'excellent' ? 1.10 : condition === 'bad' ? 0.90 : 1.00;
    const condAdj = (base + kmAdj + yearAdj) * (condMult - 1);
    const final = Math.max(1000, (base + kmAdj + yearAdj) * condMult);
    const prices = v.purchases.map(p => p.price);
    setResult({ base, kmAdj, yearAdj, condAdj, final, fees: v.avgFees, min: Math.min(...prices), max: Math.max(...prices), v, condition });
  };

  const condButtons = [
    { key: 'bad', label: 'Bad  -10%', color: 'var(--coral)', bg: 'var(--coral-l)' },
    { key: 'fair', label: 'Fair  standard', color: 'var(--blue)', bg: 'var(--blue-l)' },
    { key: 'excellent', label: 'Excellent  +10%', color: 'var(--green)', bg: 'var(--green-l)' },
  ];

  return (
    <div style={{ maxWidth: 680 }}>
      <div className="full-panel">
        <div className="panel-title">🔍 Vehicle Purchase Price Recommender</div>
        <div style={{ fontSize: 12, color: 'var(--text-2)', marginBottom: 16 }}>
          Based on your actual auction purchase history — weighted to recent invoices
        </div>

        <div style={{ marginBottom: 14 }}>
          <label className="login-label">Vehicle type</label>
          <select className="login-input" value={vehicleKey} onChange={e => { setVehicleKey(e.target.value); setResult(null); }}>
            <option value="">— Select vehicle type —</option>
            <option value="sprinter319">Mercedes Sprinter 319CDI</option>
            <option value="sprinter313316">Mercedes Sprinter 313/316CDI</option>
            <option value="hiaceLWB">Toyota Hiace LWB (KDH201R)</option>
            <option value="hiaceSLWB">Toyota Hiace SLWB (KDH221R)</option>
          </select>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 14 }}>
          <div>
            <label className="login-label">Odometer (km)</label>
            <input className="login-input" type="number" value={km} onChange={e => setKm(e.target.value)} placeholder="e.g. 250000" />
          </div>
          <div>
            <label className="login-label">Build year</label>
            <input className="login-input" type="number" value={year} onChange={e => setYear(e.target.value)} placeholder="e.g. 2017" />
          </div>
        </div>

        <div style={{ marginBottom: 16 }}>
          <label className="login-label">Condition</label>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 8 }}>
            {condButtons.map(b => (
              <button key={b.key} onClick={() => setCondition(b.key)} style={{
                padding: '9px 8px', fontSize: 12, fontWeight: 500, cursor: 'pointer',
                borderRadius: 'var(--radius)', border: '1px solid',
                borderColor: condition === b.key ? b.color : 'var(--border-strong)',
                background: condition === b.key ? b.bg : 'var(--surface)',
                color: condition === b.key ? b.color : 'var(--text-2)',
        ...
        <button className="login-btn" onClick={calculate} disabled={!vehicleKey}>
      ...
      {result && (
        <div className="full-panel">
          <div style={{ marginBottom: 16 }}>
            <div style={{ fontSize: 11, color: 'var(--text-2)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 4 }}>Recommended bid price</div>
            <div style={{ fontSize: 40, fontWeight: 600, color: 'var(--text)', lineHeight: 1, marginBottom: 4 }}>{fmtMoney(result.final)}</div>
            <div style={{ fontSize: 13, color: 'var(--text-2)' }}>
              All-in budget (incl. ~{fmtMoney(result.fees)} fees): <strong style={{ color: 'var(--text)' }}>{fmtMoney(result.final + result.fees)}</strong>
            </div>
          </div>

          <div className="panel" style={{ marginBottom: 16, background: 'var(--bg)' }}>
            <div className="panel-title" style={{ marginBottom: 8 }}>Adjustment breakdown</div>
            <div className="row">
              <span className="row-label">Weighted base price</span>
              <span className="row-value">{fmtMoney(result.base)}</span>
            </div>
            <div className="row">
              <span className="row-label">Km adjustment {km ? `(${parseInt(km).toLocaleString()} km vs avg ${result.v.avgKm.toLocaleString()} km)` : '(not entered)'}</span>
              <span className={`row-value ${result.kmAdj > 0 ? 'row-pos' : result.kmAdj < 0 ? 'row-neg' : ''}`}>
                {result.kmAdj === 0 ? '—' : (result.kmAdj > 0 ? '+' : '') + fmtMoney(result.kmAdj)}
              </span>
            </div>
            <div className="row">
              <span className="row-label">Year adjustment {year ? `(${year} vs avg ${result.v.avgYear})` : '(not entered)'}</span>
              <span className={`row-value ${result.yearAdj > 0 ? 'row-pos' : result.yearAdj < 0 ? 'row-neg' : ''}`}>
                {result.yearAdj === 0 ? '—' : (result.yearAdj > 0 ? '+' : '') + fmtMoney(result.yearAdj)}
              </span>
            </div>
            <div className="row">
              <span className="row-label">Condition ({result.condition})</span>
              <span className={`row-value ${result.condAdj > 0 ? 'row-pos' : result.condAdj < 0 ? 'row-neg' : ''}`}>
                {Math.abs(result.condAdj) < 1 ? '—' : (result.condAdj > 0 ? '+' : '') + fmtMoney(result.condAdj)}
              </span>
            </div>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 10, marginBottom: 16 }}>
            {[['Dataset low', result.min], ['Weighted avg', Math.round(result.base)], ['Dataset high', result.max]].map(([l, v]) => (
              <div key={l} className="kpi-card">
                <div className="kpi-label">{l}</div>
                <div className="kpi-value" style={{ fontSize: 18 }}>{fmtMoney(v)}</div>
              </div>
            ))}
          </div>

          <div className="panel-title">Purchase history ({result.v.purchases.length} invoices)</div>
          <div className="scroll-list-sm">
            {[...result.v.purchases].sort((a, b) => b.price - a.price).map((p, i) => (
              <div key={i} className="row">
                <span className="row-label">{p.date} · {p.km.toLocaleString()} km · {p.year} · <span style={{ fontFamily: 'DM Mono, monospace', fontSize: 11 }}>{p.invoice}</span></span>
                <span className="row-value">{fmtMoney(p.price)}</span>
              </div>
            ))}
          </div>
          <div style={{ fontSize: 12, color: 'var(--text-2)', marginTop: 12, lineHeight: 1.6 }}>ℹ {result.v.note}</div>
        </div>
      )}
    </div>
  );
  ...
  return (
    <div className="dash-wrap">
      ...
      <div className="tabs" style={{ marginBottom: 20 }}>
        {[['operations', '🚐  Operations'], ['pricer', '🔍  Price Recommender']].map(([key, label]) => (
          <button key={key} className={`tab${activeTab === key ? ' active' : ''}`} onClick={() => setActiveTab(key)}>{label}</button>
        ))}
      </div>

      {activeTab === 'pricer' && <PriceRecommender />}
